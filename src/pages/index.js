        ...
        <div className="container mx-auto  text-center ">
          ...
          <div className="flex justify-center items-center flex-wrap sm:flex-row sm:-mx-3 mt-12">
            {coordinators.map(coordinator => (
              ...
              //   <img className="w-8/12 mb-4 object-contain rounded-full" src={coordinator.imageName}/>
          ...
          <Slider {...settings}>
            {studentData.map((student, index) => (
              <div key={index} className="flex-1 outline-none mx-0 p-2">
                <StudentCard student={student} image={findImage(images, student.imageName)} />
              </div>
            ))}
          </Slider>
        </div>
